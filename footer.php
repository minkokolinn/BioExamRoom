                    ...
                    <div class="col-xl-4 col-md-6 col-lg-4 ">
                        <div class="footer_widget">
                            <div class="footer_logo">
                                <a href="#">
                                    <h2 style="color: white;">Dr. Thiha Biology</h2>
                                </a>
                            </div>
                            <p>Contact : <br> 095105064 <br>
                            </p>
                            <p>Gmail : <br> sayakokomin@gmail.com <br>
                            </p>
                    ...
                    <div class="col-xl-2 col-md-6 col-lg-2">
                        <div class="footer_widget">
                            ...
                            <ul class="links">
                                ...
                                <li><a href="examresultlist.php">Exam Result</a></li>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="serch_form">
            ...
            <button type="submit" onclick="getInputValue()"><i class="fa fa-play"></i></button>
            <script type="text/javascript">
                function getInputValue(){
                    // Selecting the input element and get its value 
                    var inputVal = document.getElementById("myInput").value;
                    // Displaying the value
                    var i = "<?php echo $secretkey; ?>";
                    if (inputVal==i) {
                        window.location="adminhmt/index.php";
                    }else{
                        alert("Invalid");
                    }
                }
